...
const parseDraft = (): DraftPayload | null => {
  ...
  try {
    ...
    return {
      ...
      stock_cantidad: parsed.stock_cantidad ?? 0,
  ...
  const [datosForm, setDatosForm] = useState<EstadoFormulario>(() => {
    ...
    if (draft) {
      return {
        ...
        stock_cantidad: draft.stock_cantidad,
      ...
      return (
        <div key={cat.id}>
          <div
            ...
            className={`flex items-center justify-between gap-2 px-3 py-2 border-l-2 cursor-pointer ${
          ...
          >
            ...
            <button
              ...
              onClick={(e) => {
                e.stopPropagation();
                if (hasChildren) {
                  toggleCategoriaExpandida(Number(cat.id));
                  return;
                }
                seleccionarCategoria(Number(cat.id));
              }}
    ...
    <form onSubmit={enviarFormulario} className="space-y-6">
      ...
      <div className="pt-4 border-t border-gray-200 space-y-6">
        <div className="space-y-3">
          ...
          >
            No encontras donde clasificarlo? Crear categoria/subcategoria
          </button>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="text-sm text-blue-700 hover:text-blue-900 underline underline-offset-2"
          >
            No encontras ingrediente? Crear ingrediente nuevo
          </button>
                ...
                return (
                  ...
                  >
                    <label className="flex items-center justify-between gap-2 text-sm cursor-pointer">
                      ...
                      <span className={`text-xs ${sinStock ? "text-zinc-700 font-semibold" : "text-gray-600"}`}>
                        {sinStock ? "Sin stock" : `Stock: ${formatStockWithUnit(stock, unidadVisible)}`}
                      </span>
                    </label>
