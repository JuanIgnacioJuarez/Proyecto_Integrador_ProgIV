...
/**
 * Interfaz de Props del componente clave de la pantalla de usuarios.
 * (Requisito del parcial: "Estructura y Tipado" — componente + interfaz TS.)
 */
export interface FilaUsuarioProps {
  usuario: Usuario;
  /** Id del admin logueado: deshabilita acciones sobre la propia cuenta. */
  currentUserId: number | null;
  /** Indica si hay una mutación en curso para esta fila. */
  isMutating: boolean;
