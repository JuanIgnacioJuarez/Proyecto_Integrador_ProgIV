        ...
        <GrillaProductos
          ...
          action={
            canManageCatalogo ? (
              ...
              <Link
                to="/carrito"
                className="bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-600/95 dark:hover:bg-emerald-500 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
              >
                Ver carrito
              </Link>
            ) : (
