...
def crear_pedido(
    ...
    """Crea un pedido desde el carrito. Requiere estar autenticado."""
...
def list_pedidos(
    ...
    """
    ADMIN y PEDIDOS ven todos los pedidos.
    CLIENT solo ve los propios.
    """
    return svc.get_all(
...
def get_pedido(
    ...
    """Detalle completo con detalles e historial de estados."""
...
def avanzar_estado(
    ...
    """
    Avanza el estado del pedido según la máquina de estados.
    ADMIN/PEDIDOS pueden avanzar cualquier transición.
