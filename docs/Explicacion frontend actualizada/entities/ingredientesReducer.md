# Explicacion detallada de entities\ingredientesReducer.ts

## Rol del archivo

Este archivo es un reducer de estado dentro de la zona de arquitectura general del frontend.
...
- No depende de hooks complejos; su responsabilidad es mas declarativa o estructural.
